...
public class UserController : ControllerBase
{
    ...
    /*
     ...
     Nó là 1 từ khóa rất quan trọng, xương sống của .NET
     Các thư viện đều sd DI. K biết DI thì k code đc
     Lý thuyết sâu xa thì nhiều, nhưng sd thì chỉ có vài dòng
     VD:
        - private readonly AppDbContext _dbContext; (Khai báo sd)
        - public UserController(AppDbContext dbContext, IConfiguration configuration) (Thêm vào)
        {
    ...
    [HttpPost("register")]  //Body: dữ liệu sẽ đc truyền qua body, nên k cần phải đặt tham số trong url
    ...
    {
        var result = await _userService.UpdateUser(id, requestBody);
        return Ok(result);
    }
